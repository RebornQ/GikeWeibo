...
public class RetweetedStatus {
    ...
    @Expose
    private List<PicUrl_> picUrls = null;
    ...
    @Expose
    private CommentManageInfo_ commentManageInfo;
    ...
    public List<PicUrl_> getPicUrls() {
        return picUrls;
    }

    public void setPicUrls(List<PicUrl_> picUrls) {
    ...
    public Visible_ getVisible() {
        return visible;
    }

    public void setVisible(Visible_ visible) {
    ...
    public CommentManageInfo_ getCommentManageInfo() {
        return commentManageInfo;
    }

    public void setCommentManageInfo(CommentManageInfo_ commentManageInfo) {
